...
####################################################
import pygame
from src.utility import load_json, get_sprite, cartesian_to_iso, move_sprite
RED = (255, 0, 0)
...
class Tile(pygame.sprite.Sprite):
    ...
    def init_tile(self):
        ...
        self.rect.x=self.isox+MAP_WIDTH/2
...
class IsoTileMap(pygame.sprite.Sprite):
    def __init__(self,x,y,json, scale=1):
        pygame.sprite.Sprite.__init__(self)
        self.x = x
        self.y = y
        self.json = json
    ...
    def draw_tile(self, x, y, z, tile_frame,sort):
        ...
        tile = Tile(tile_sprite, tile_frame,x,y,z,w,h,isox+self.x,isoy+self.y,offsetx,offsety,self.colorkey,self.scale,sort)
        self.sort_tile(tile)
